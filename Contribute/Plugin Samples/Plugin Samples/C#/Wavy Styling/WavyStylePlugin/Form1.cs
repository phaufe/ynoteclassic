...
namespace WavyStylePlugin
{
    ...
    public partial class Form1 : WeifenLuo.WinFormsUI.Docking.DockContent, IFormPlugin
    {
        ...
        public Form1()
        {
            ...
            Hide();
            this.Visible = false;
            Main.ActiveFastColoredTextBox.TextChangedDelayed += new EventHandler<TextChangedEventArgs>(ActiveFastColoredTextBox_TextChangedDelayed);
        ...
        private void ActiveFastColoredTextBox_TextChangedDelayed(object sender, TextChangedEventArgs e){
            SpellChecker SpellChecker = new SpellChecker(Main.ActiveFastColoredTextBox, @"Dictionary.dic");
