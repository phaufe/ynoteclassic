...
class Form1(WeifenLuo.WinFormsUI.Docking.DockContent, IFormPlugin):
	...
	def __init__(self):
		...
		self.Hide()
		self._Visible = False
		Main.ActiveFastColoredTextBox.TextChangedDelayed += self.ActiveFastColoredTextBox_TextChangedDelayed
	...
	def ActiveFastColoredTextBox_TextChangedDelayed(self, sender, e):
		SpellChecker = SpellChecker(Main.ActiveFastColoredTextBox, @"Dictionary.dic")
