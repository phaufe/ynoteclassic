...
module HighlightingPluginSample
	class MainForm < DockContent, IFormPlugin
		...
		def ActiveFastColoredTextBox_TextChangedDelayed(sender, e)
		...
		def button1_Click(sender, e)
			begin
				Main.ActiveFastColoredTextBox.TextChangedDelayed { |sender, e| self.ActiveFastColoredTextBox_TextChangedDelayed(sender, e) }
