...
Public Class MainForm
    ...
    Private Sub codebox_TextChangedDelayed(sender As Object, e As TextChangedEventArgs)
    ...
    Private Sub button1_Click(sender As Object, e As EventArgs)
        Try
            AddHandler Main.ActiveFastColoredTextBox.TextChangedDelayed, New EventHandler(Of TextChangedEventArgs)(AddressOf codebox_TextChangedDelayed)
    ...
    Private Sub button2_Click(sender As Object, e As EventArgs)
        Try
            Main.ActiveEditor.codebox.InsertText("kernel void Mono(" & vbLf & "_global uchar4 *input," & vbLf & "const float2 file" & vbLf & ")" & vbLf & vbLf & "int Main()" & vbLf & "{" & vbLf & "int coord=(int2)(get_global_id(0));" & vbLf & "}")
        Catch
        End Try
    End Sub
End Class
